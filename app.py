...
@app.route('/download_report/<prediction>/<confidence>/<filename>')
def download_report(prediction, confidence, filename):
    # Example logic: create a PDF or send file
    return f"Report for {filename} - {prediction} ({confidence} confidence)"
